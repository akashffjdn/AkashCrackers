...
const sections: PolicySection[] = [
  {
    ...
    summary: 'Your satisfaction is our priority. We make returns simple and hassle-free.',
    content: (
  ...
  },
  {
    ...
    summary: 'Return within 7 days if unopened. Damaged items get immediate replacement within 48 hours.',
    content: (
      <>
  ...
  },
  {
    ...
    summary: 'Opened, used, or improperly stored products cannot be returned due to safety regulations.',
    content: (
      <>
  ...
  },
  {
    ...
    summary: 'Contact us with your Order ID, get approval, ship it back, and receive your refund in 5-7 days.',
    content: (
      <>
  ...
  },
  {
    ...
    summary: 'UPI refunds take 2-3 days, card/net banking 5-7 days, and COD 7-10 days via bank transfer.',
    content: (
  ...
  },
  {
    ...
    icon: Repeat,
    title: 'Exchanges',
    summary: 'We don\'t offer direct exchanges. Return the original item and place a new order.',
    content: (
  ...
  {
    id: 'damaged-guarantee',
    icon: Shield,
    title: 'Damaged Product Guarantee',
    summary: 'Received a damaged item? We guarantee a full replacement or refund — no questions asked.',
    content: (
      <>
  ...
  return (
    <>
      ...
      <PolicyLayout
        ...
        description="We make returns simple and hassle-free. Here's everything you need to know."
